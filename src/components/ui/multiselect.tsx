  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "min-h-10 rounded-md bg-background text-sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2",
            {
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    "data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground text-pure-white",
                    "data-[fixed]:bg-muted-foreground data-[fixed]:text-pure-white data-[fixed]:hover:bg-muted-foreground",
                    badgeClassName
                  )}
                ...
                >
                  ...
                  >
                    <X className="h-3 w-3 text-pure-white hover:text-foreground" />
                  </button>
                </Badge>
              );
            })}
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "flex-1 bg-transparent outline-none placeholder:text-muted-foreground blur-0",
                {
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute blur-0 top-1 bg-background z-[9999] w-full rounded-md text-black shadow-md outline-none animate-in"
              onMouseLeave={() => {
