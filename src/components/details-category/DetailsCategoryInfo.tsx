...
const DetailsCategoryInfo = ({ data }: TProps) => {
    ...
    function onSubmit(values: z.infer<typeof nameSchema>) {
        ...
        axios.patch(`${process.env.NEXT_PUBLIC_URL}/product-details-category/update/${selectedCat?._id}`, payload)
            .then(res => {
    ...
    useEffect(() => {
        if (openEditId !== null && selectedCat !== null) {
            setFields(selectedCat.fields.map(f => (
                {
                    field: f,
                    id: generateID()
                }
                    ...
                    <div className="bg-light-gray p-4 rounded-md flex flex-col h-full hover:shadow-md hover:scale-[1.01] transition-all z-0" key={cat._id}>
                        ...
                        <div className="flex gap-3 w-full mt-3">
                            ...
                            <Button
                                ...
                                variant={"edit"} size={'icon'}>
                                <BiSolidEditAlt size={20} />
                            </Button>


                            <Button variant={'delete'} size={'icon'} onClick={() => {
                ...
                <DialogContent>
                    ...
                    <div>
                        ...
                        <div className="flex w-full gap-3 pt-4">
                            <Button className="w-full" onClick={handleCloseModal}>Cancel</Button>
